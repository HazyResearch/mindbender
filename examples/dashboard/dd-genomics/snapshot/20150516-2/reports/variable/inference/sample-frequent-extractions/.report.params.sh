...
: ${num_most_frequent_extractions:=100}  # the number of most frequent extractions to enumerate
export variable expectation_threshold candidate_id_column words_column doc_id_column num_most_frequent_extractions
