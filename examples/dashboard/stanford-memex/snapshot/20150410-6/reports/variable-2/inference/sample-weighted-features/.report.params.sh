...
: ${num_top_weighted_features:=10}  # the number of highly weighted features to enumerate
export variable expectation_threshold candidate_id_column words_column doc_id_column num_top_extractions num_top_weighted_features
